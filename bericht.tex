...
Diese können z.B. die Koordination von Markern auf einem Robotergreifarm sein.
Die gemessenen Daten werden immer öfter mittels maschinellem Lernen verarbeitet, beispielsweise um Anomalien zu erkennen.
Hierfür werden sie vor der Verwendung aufbereitet.\\
...
Für die angenehmere Verwendung der neuen Sprache PrePro wurde zusätzlich ein Plugin mit Syntaxhervorhebung für die NetBeans IDE implementiert.
\end{abstract}
